...
public class Activity13 extends AppCompatActivity implements View.OnClickListener {
    ...
    public CardView card_home, card_semperoper, card_semperoper_image6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_semperoper_image6 = (CardView) findViewById(R.id.semperoper_image6);
        ...
        card_semperoper_image6.setOnClickListener(this);
    ...
    public void onClick(View vg) {
        ...
        switch (vg.getId()) {
            ...
            case R.id.home:
                ...
                ig = new Intent( this, MainActivity.class);
            ...
            case R.id.semperoper:
                /*below code line: c1 is the card1. So, once we click on the card1 it has to go to the activity one. Therefore, we write One.class for go to the activity one*/
                ig = new Intent( this, Activity14.class);
