...
public class Activity10 extends AppCompatActivity implements View.OnClickListener {
    ...
    public CardView card_home, card_semperoper, card_semperoper_image3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_semperoper_image3 = (CardView) findViewById(R.id.semperoper_image3);
        ...
        card_semperoper_image3.setOnClickListener(this);
    ...
    public void onClick(View vc) {
        ...
        switch (vc.getId()) {
            ...
            case R.id.semperoper:
                /*below code line: c1 is the card1. So, once we click on the card1 it has to go to the activity one. Therefore, we write One.class for go to the activity one*/
                ic = new Intent( this, Activity14.class);
