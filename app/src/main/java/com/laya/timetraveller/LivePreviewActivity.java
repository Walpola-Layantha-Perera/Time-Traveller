...
import com.laya.timetraveller.cloudlandmarkrecognition.CloudLandmarkRecognitionProcessor;
import com.laya.timetraveller.custommodel.CustomImageClassifierProcessor;
import com.laya.timetraveller.facedetection.FaceDetectionProcessor;
import com.laya.timetraveller.imagelabeling.ImageLabelingProcessor;
import com.laya.timetraveller.textrecognition.TextRecognitionProcessor;
...
public final class LivePreviewActivity extends AppCompatActivity
  ...
  private static final String FACE_DETECTION = "";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    options.add(LANDMARK_RECOGNITION);
    ...
    try {
      switch (model) {
        ...
        case LANDMARK_RECOGNITION:
          Log.i(TAG, "Using Landmark Recognition Processor");
