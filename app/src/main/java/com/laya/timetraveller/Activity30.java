...
public class Activity30 extends AppCompatActivity implements View.OnClickListener {

    /*making 6 objects for 6  class views*/

    public CardView card_home, card_zwinger, card_zwinger_image3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_zwinger = (CardView) findViewById(R.id.zwinger6);
        card_zwinger_image3 = (CardView) findViewById(R.id.zwinger_image3);
        ...
        card_zwinger_image3.setOnClickListener(this);
    ...
    public void onClick(View vc) {
        ...
        switch (vc.getId()) {
            ...
            case R.id.zwinger6:
                /*below code line: c1 is the card1. So, once we click on the card1 it has to go to the activity one. Therefore, we write One.class for go to the activity one*/
                ic = new Intent( this, Activity16.class);
