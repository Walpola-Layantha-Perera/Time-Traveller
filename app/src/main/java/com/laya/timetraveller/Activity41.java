...
public class Activity41 extends AppCompatActivity implements View.OnClickListener {

    /*making 6 objects for 6  class views*/

    public CardView card_home, card_katholische, card_katholische_image3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_katholische = (CardView) findViewById(R.id.katholische6);
        card_katholische_image3 = (CardView) findViewById(R.id.katholische_image3);
        ...
        card_katholische_image3.setOnClickListener(this);
    ...
    public void onClick(View vc) {
        ...
        switch (vc.getId()) {
            ...
            case R.id.katholische6:
                /*below code line: c1 is the card1. So, once we click on the card1 it has to go to the activity one. Therefore, we write One.class for go to the activity one*/
                ic = new Intent( this, Activity18.class);
