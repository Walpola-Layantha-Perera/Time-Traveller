...
public class Activity49 extends AppCompatActivity implements View.OnClickListener {

    /*making 6 objects for 6  class views*/

    public CardView card_home, card_japanesepalace, card_japanesepalace_image3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_japanesepalace = (CardView) findViewById(R.id.japanesepalace6);
        card_japanesepalace_image3 = (CardView) findViewById(R.id.japanesepalace_image3);
        ...
        card_japanesepalace_image3.setOnClickListener(this);
    ...
    public void onClick(View vc) {
        ...
        switch (vc.getId()) {
            ...
            case R.id.japanesepalace6:
                /*below code line: c1 is the card1. So, once we click on the card1 it has to go to the activity one. Therefore, we write One.class for go to the activity one*/
                ic = new Intent( this, Activity19.class);
